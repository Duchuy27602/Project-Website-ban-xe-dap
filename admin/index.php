            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="card">
                        ...
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                        <p class="mb-0"><span class="text-success text-sm font-weight-bolder"><?= topOrderMonthGet()['user_name'] != '' ? topOrderMonthGet()['user_name'] . ' is the biggest buyer' : '&nbsp;' ?></span></p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6">
                    <div class="card">
                        ...
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                        <p class="mb-0"><span class="text-success text-sm font-weight-bolder"><?= topProductOrderMonthGet()['product_name'] != '' ? topProductOrderMonthGet()['product_name'] : '&nbsp;' ?></span></p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6">
